...
(function () {
  ...
  // VARIABLES
  var timeline = document.querySelector(".timeline-s ol"),
      elH = document.querySelectorAll(".timeline-s li > div"),
      arrows = document.querySelectorAll(".timeline-s .arrows .arrow"),
      arrowPrev = document.querySelector(".timeline-s .arrows .arrow__prev"),
      arrowNext = document.querySelector(".timeline-s .arrows .arrow__next"),
      firstItem = document.querySelector(".timeline-s li:first-child"),
      lastItem = document.querySelector(".timeline-s li:last-child"),
      xScrolling = 280,
